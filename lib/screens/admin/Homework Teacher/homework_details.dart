...
class _HomeworkDetailsScreenState extends State<HomeworkDetailsScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _submitHomework() async {
    ...
    try {
      await _homeworkService.submitHomework(
        ...
        studentId: widget.adminData?['uid'] ?? 'unknown',
        studentName: widget.adminData?['name'] ?? 'Unknown Student',
          ...
          SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                if (widget.adminData?['role'] != 'admin')
